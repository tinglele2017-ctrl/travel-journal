    ...
    <div>
      ...
      <section className="border-t bg-gray-50 py-12">
        <div className="mx-auto grid max-w-6xl grid-cols-3 gap-8 px-4 text-center">
          <div>
            <div className="text-4xl font-bold text-primary">{journals.length}+</div>
          ...
          <div>
            <div className="text-4xl font-bold text-primary">{hotDests.length}</div>
